...
export class player {
  ...
  updatePlayer(delta, keysPressed, firstPerson, camera, ball) {
    ...
    if (this.currentAction == "run") {
      ...
      // this.runDirection.x = cameraDirection.x
      lookPoint.x = this.model.position.x + (10)*cameraDirection.x;
      lookPoint.y = this.model.position.y ;
      lookPoint.z = this.model.position.z + (10)*cameraDirection.z;
      this.model.lookAt(lookPoint.x, lookPoint.y, lookPoint.z);
      this.runDirection.x = lookPoint.x - this.model.position.x;
      this.runDirection.y = lookPoint.y - this.model.position.y;
      this.runDirection.z = lookPoint.z - this.model.position.z;
    }
  ...
  updatePlayerUp(delta, keysPressed, camera) {
    ...
    if (this.currentAction == "run") {
      ...
      // console.log("angle Y cameraDirection",angleYCameraDirection);
